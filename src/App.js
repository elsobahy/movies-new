  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path='/movie' element={<ProtectRoutes><Movies /></ProtectRoutes>} />
        <Route path='/movie/:id' element={<ProtectRoutes><MovieDetail /></ProtectRoutes>} />
        <Route path='/search' element={<ProtectRoutes><Search /></ProtectRoutes>} />
        <Route path='/hero' element={<ProtectRoutes><Heroes /></ProtectRoutes>} />
        <Route path='/hero/:heroId' element={<ProtectRoutes><HeroDetail /></ProtectRoutes>} />
        <Route path='/watchlists' element={<ProtectRoutes><Watchlists /></ProtectRoutes>} />
